...
import com.portfoliolarosa.lr.Security.Dto.JwtDto;
import com.portfoliolarosa.lr.Security.Dto.LoginUsuario;
import com.portfoliolarosa.lr.Security.Dto.NuevoUsuario;
...
public class AuthController {
    ...
    public ResponseEntity<JwtDto> login(@Valid @RequestBody LoginUsuario loginUsuario, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return new ResponseEntity(new Mensaje("Campos mal llenados"), HttpStatus.BAD_REQUEST);
        }
